...
class DatabaseHelper {
  ...
  Future<Database> _initDb() async {
    ...
    final todoAppDb = await openDatabase(path, version: 1, onCreate: _createDb);
    return todoAppDb;
  }

  void _createDb(Database db, int version) async {
    await db.execute('CREATE TABLE $taskTable('
        '$colId INTEGER PRIMARY KEY AUTOINCREMENT, $colTitle TEXT, $colDate TEXT, $colPriority TEXT, $colStatus INTEGER)');
  }
